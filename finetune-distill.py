...
from haq_lib.lib.utils.quantize_utils import QConv2d, QLinear, calibrate
...
def main():
    ...
    strategy = [4, 4, 4, 4, 2, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 
                4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 
                4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 2, 4, 2, 4, 4, 
                2, 2, 4, 4, 4, 4, 4, 4, 4, 4, 4, 2, 2, 2, 2, 
                2, 4, 4, 4, 4, 2, 4, 4, 4, 4, 4, 4, 4, 4, 4, 
                2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 
                2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
    print('strategy for : ', strategy)
    ...
    for epoch in range(start_epoch, args.epoch):
        if args.free_high_bit and epoch == args.epoch - 1:
    ...
    shutil.copy(savepath, './fintuned_model.pth')
